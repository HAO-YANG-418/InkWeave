...
const BUILTIN_NODES: NodeDefinition[] = [
  ...
  },
  {
    ...
    options: [
      'opt_emotion_show',      // 以动写情（身体反应+动作，默认，Show don't tell）
      'opt_emotion_tell',      // 直抒胸臆（直接写心理和情绪）
      'opt_emotion_both',      // 内外结合（动作描写+内心独白）
    ],
  },
  {
    id: 'node_tone',
    ...
    options: [
      ...
      'opt_tone_colloquial',   // 口语白话（接地气，现代口语感）
      'opt_tone_serious',      // 严肃正剧（沉稳厚重，默认）
  ...
  // ========== 规则类 (rule) - 3个 ==========
  {
    ...
    options: [
      ...
      'opt_length_2200',       // 2200字左右（标准章节，默认）
